...
#gsutil -m cp gs://acl-2022-storage/concat_fold_1/model_* $HOME/concat_fold_1/
...
do
	...
	do
		...
		python src/re_gold_qa_train.py \
			...
			--gpu_device 0 \
			--seed 12321 \
			--prediction_file $HOME/concat_fold_1/concat_fold_1.test.predictions.0.step.${step}.csv &
	done
	wait
done
