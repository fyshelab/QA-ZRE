...
#SBATCH --job-name=reqa_pg_pg_sim_on_fold_0
...
do
        ...
        python src/re_gold_qa_train.py \
                --mode re_qa_test \
		--model_path $SCRATCH/fold_1/pg-pg-on-sim/ \
		...
		--num_search_samples 8 \
                ...
                --gpu_device 0 \
                --seed 12321 \
                --prediction_file $SCRATCH/fold_1/pg-pg-on-sim/pg_pg_on_sim.dev.predictions.step.${step}.csv
done
...
python src/re_gold_qa_train.py \
	--mode re_qa_test \
	--model_path $SCRATCH/fold_1/pg-pg-on-sim/ \
	--answer_checkpoint _0_answer_step_2500 \
	--question_checkpoint _0_question_step_2500 \
	--num_search_samples 8 \
	--batch_size 64 --gpu True \
	--ignore_unknowns True \
	--train zero-shot-extraction/relation_splits/train.very_small.0 \
	...
	--gpu_device 0 \
	--seed 12321 \
	--prediction_file $SCRATCH/fold_1/pg-pg-on-sim/pg_pg_on_sim.test.predictions.step.2500.csv
