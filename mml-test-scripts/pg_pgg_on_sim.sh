...
#SBATCH --job-name=reqa_pg_pgg_sim_on_fold_0
...
do
        ...
        python src/re_gold_qa_train.py \
                --mode re_qa_test \
		--model_path $SCRATCH/fold_1/pg-pgg-on-sim/ \
		...
		--num_search_samples 8 \
                ...
                --gpu_device 0 \
                --seed 12321 \
                --prediction_file $SCRATCH/fold_1/pg-pgg-on-sim/pg_pgg_on_sim.dev.predictions.step.${step}.csv
done
...
python src/re_gold_qa_train.py \
	...
	--gpu_device 0 \
	--seed 12321 \
	--prediction_file $SCRATCH/fold_1/pg-pgg-on-sim/pg_pgg_on_sim.test.predictions.step.5300.csv
