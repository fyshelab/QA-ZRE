...
#SBATCH --job-name=test+reqa_mml+mml_on_iter_fold_0
...
python src/re_gold_qa_train.py \
	--mode re_qa_train \
	--model_path $SCRATCH/fold_1/mml-on-iter+mml/ \
...
do
		...
		--num_search_samples 8 \
                ...
                --gpu_device 0 \
                --seed 12321 \
                --prediction_file $SCRATCH/fold_1/mml-on-iter+mml/mml_on_iter+mml.dev.predictions.step.${step}.csv
done
'''
python src/re_gold_qa_train.py \
	--mode re_qa_test \
	...
	--gpu_device 0 \
	--seed 12321 \
	--prediction_file $SCRATCH/fold_1/mml-on-iter+mml/mml_on_iter+mml.test.predictions.step.2900.csv
