...
#SBATCH --job-name=final_test+reqa_mml+mml_off_iter_fold_0
...
python src/re_gold_qa_train.py \
	--mode re_qa_train \
	--model_path $SCRATCH/fold_1/mml-off-iter+mml/ \
...
do
		...
		--num_search_samples 8 \
                ...
                --gpu_device 0 \
                --seed 12321 \
                --prediction_file $SCRATCH/fold_1/mml-off-iter+mml/mml_off_iter+mml.dev.predictions.step.${step}.csv
done
...
python src/re_gold_qa_train.py \
	--mode re_qa_test \
	--model_path $SCRATCH/fold_1/mml-off-iter+mml/ \
	--answer_checkpoint _0_answer_step_14300 \
	--question_checkpoint _0_question_step_14300 \
	--num_search_samples 8 \
	--batch_size 64 --gpu True \
	--ignore_unknowns True \
	--train zero-shot-extraction/relation_splits/train.very_small.0 \
	...
	--gpu_device 0 \
	--seed 12321 \
	--prediction_file $SCRATCH/fold_1/mml-off-iter+mml/mml_off_iter+mml.test.predictions.step.14300.csv
