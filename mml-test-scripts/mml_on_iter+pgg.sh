...
#SBATCH --job-name=final_test_reqa_pgg+mml_on_iter_fold_0
...
python src/re_gold_qa_train.py \
	--mode re_qa_train \
	--model_path $SCRATCH/fold_1/mml-on-iter+pgg/ \
	--answer_checkpoint _response_pretrained \
	--question_checkpoint _question_best_mml_on \
...
do
		...
		--num_search_samples 8 \
                ...
                --gpu_device 0 \
                --seed 12321 \
                --prediction_file $SCRATCH/fold_1/mml-on-iter+pgg/mml_on_iter+pgg.dev.predictions.step.${step}.csv
done
'''
python src/re_gold_qa_train.py \
	--mode re_qa_test \
	--model_path $SCRATCH/fold_1/mml-on-iter+pgg/ \
	--answer_checkpoint _0_answer_step_2600 \
	--question_checkpoint _0_question_step_2600 \
	--num_search_samples 8 \
	--batch_size 64 --gpu True \
	--ignore_unknowns True \
	--train zero-shot-extraction/relation_splits/train.very_small.0 \
	...
	--gpu_device 0 \
	--seed 12321 \
	--prediction_file $SCRATCH/fold_1/mml-on-iter+pgg/mml_on_iter+pgg.test.predictions.step.2600.csv
