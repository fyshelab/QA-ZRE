...
#SBATCH --job-name=reqa_pg_iter_off_fold_0
...
do
        ...
        python src/re_gold_qa_train.py \
                --mode re_qa_test \
		--model_path $SCRATCH/fold_1/pg-off-iter/ \
		...
		--num_search_samples 8 \
                ...
                --gpu_device 0 \
                --seed 12321 \
                --prediction_file $SCRATCH/fold_1/pg-off-iter/pg_off_iter.dev.predictions.step.${step}.csv
done
