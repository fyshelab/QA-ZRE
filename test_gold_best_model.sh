...
python src/re_gold_qa_train.py \
	...
	--gpu_device 0 \
	--seed 12321 \
	--prediction_file $HOME/gold_fold_1/gold_fold_1.test.predictions.0.step.0.csv
gsutil -m cp $HOME/gold_fold_1/gold_fold_1.test.predictions.0.step.0.csv gs://acl-2022-storage/gold_fold_1/
